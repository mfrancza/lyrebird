...
from lyrebird import FiniteImpulseResponseDataSet, FiniteImpulseResponseModel, train_epoch, evaluate, transform
...
class TestTransformFunction:
    ...
    def test_transform_function(self, temp_wav_files):
        ...
        # Transform the audio
        transform(model, temp_wav_files['input_path'], output_path, buffer_length, device)
        ...
        input_waveform, input_sample_rate = torchaudio.load(temp_wav_files['input_path'])
        ...
        assert torch.allclose(output_waveform[:, :buffer_length], input_waveform[:, :buffer_length])
    ...
    def test_transform_mono_audio(self, temp_wav_files):
        ...
        transform(model, temp_wav_files['mono_input_path'], output_path, buffer_length, device)
